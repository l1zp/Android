package com.example.lizp.databasetest;
...
public class DatabaseProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.lizp.databasetest.provider";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case BOOK_DIR:
                return "vnd.android.cursor.dir/vnd.com.example.lizp.databasetest." +
                        "provider.book";
            case BOOK_ITEM:
                return "vnd.android.cursor.item/vnd.com.example.lizp.databasetest." +
                        "provider.book";
            case CATEGORY_DIR:
                return "vnd.android.cursor.dir/vnd.com.example.lizp.databasetest." +
                        "provider.category";
